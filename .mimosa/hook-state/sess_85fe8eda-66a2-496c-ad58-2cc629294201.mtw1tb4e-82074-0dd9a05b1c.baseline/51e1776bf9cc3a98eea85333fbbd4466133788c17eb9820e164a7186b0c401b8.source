/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-tool-office`.
 * @module @deepseek-ai/dsh-tool-office/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-tool-office'
