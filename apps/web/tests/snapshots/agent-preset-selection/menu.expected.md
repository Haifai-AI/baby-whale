- menu:
  ...
  - 'menuitem "Coworker mode Coworker mode: a knowledge-work agent that produces office documents, runs long-term goals, and does not open a shell by default; file writes ask for confirmation."'
