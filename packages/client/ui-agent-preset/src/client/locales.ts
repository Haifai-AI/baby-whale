...
export type AgentPresetSettingsKey =
  ...
  | 'presetCoworkerName' | 'presetCoworkerDescription'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  presetCoworkerName: 'Coworker mode',
  presetCoworkerDescription:
    'Coworker mode: a knowledge-work agent that produces office documents, runs long-term goals, and does not open a shell by default; file writes ask for confirmation.',
  duplicate: 'Duplicate',
...
export const zh: Record<AgentPresetSettingsKey, string> = {
  ...
  presetCoworkerName: '同事模式',
  presetCoworkerDescription: '同事模式：面向知识工作的 Agent，生成办公文档、执行长期目标，默认不开放 Shell，所有文件写入需确认。',
  duplicate: '复制',
...
const BUILT_IN_PRESET_KEYS: Readonly<Partial<Record<string, PresetLocaleKeys>>> = {
  ...
  coworker: { name: 'presetCoworkerName', description: 'presetCoworkerDescription' },
}
