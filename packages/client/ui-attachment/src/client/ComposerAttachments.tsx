...
/** Draft-image rail, document drop target (images *and* workspace uploads), and original-image preview slot entry. */
export function ComposerAttachments({
  ...
  useEffect(() => {
    ...
    const onDrop = (event: globalThis.DragEvent): void => {
      ...
      // Partition by kind when uploads are wired: images ride the validated
      // draft rail; everything else lands in the session workspace directly.
      ...
      if (documents.length > 0) onUploadFiles(documents)
    }
