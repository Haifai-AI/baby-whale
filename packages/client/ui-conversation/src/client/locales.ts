...
export const zh = {
  ...
  'file.uploadFailed': '{name} 上传失败',
  'file.uploaded': '{name} 已加入工作区',
  ...
  'chat.process.label': '过程',
  'chat.process.hide': '隐藏本轮的调用与思考',
  'chat.process.show': '显示本轮的调用与思考',
  'chat.run.summary': '{count} 次工具调用 · {duration}',
  'chat.run.summaryHint': '{count} 次工具调用 · 点击展开',
  'chat.run.summaryUntimed': '{count} 次工具调用',
  'chat.run.expand': '展开 {count} 次工具调用',
  'chat.run.collapse': '收起 {count} 次工具调用',
  'chat.loadOlder': '加载更早',
  'chat.toBottom': '回到底部',
...
export const en = {
  ...
  'file.uploadFailed': 'Could not upload {name}',
  'file.uploaded': '{name} added to the workspace',
  ...
  'hero.headline': 'Into the Darkness',
  'hero.preview': 'Preview',
  'hero.chooseWorkspace': 'Choose workspace',
  'session.hierarchy': 'Session hierarchy',
  'details.title': 'Details',
  'details.close': 'Close details',
  'details.expand': 'Expand preview',
  'details.collapse': 'Collapse preview',
  ...
  'chat.process.label': 'Process',
  'chat.process.hide': 'Hide tool calls and reasoning for this turn',
  'chat.process.show': 'Show tool calls and reasoning for this turn',
  'chat.run.summary': '{count} tool calls · {duration}',
  'chat.run.summaryHint': '{count} tool calls · click to show',
  'chat.run.summaryUntimed': '{count} tool calls',
  'chat.run.expand': 'Show {count} tool calls',
  'chat.run.collapse': 'Hide {count} tool calls',
