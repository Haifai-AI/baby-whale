...
const ToolCall = memo(function ToolCall({
  renderSlot, callId, toolName, block, openFile, selected, cwd, home, inspectCall, openDetails, t, children,
}: Pick<ToolTreeProps, 'renderSlot' | 'openFile' | 'cwd' | 'inspectCall' | 'openDetails' | 't'> & {
  callId: string
  toolName: string
  block: ToolCallBlock
  selected: boolean
  ...
  const owner: ToolCallOwnerProps = useMemo(() => ({
    ...
    ...openDetails !== undefined ? { openDetails } : {},
  }), [callId, toolName, block, openFile, cwd, home, inspectCall, openDetails])
  return (
    <div
...
const ToolCallBranch = memo(function ToolCallBranch({
  renderSlot, block, selectedCallId, cwd, home, openFile, inspectCall, openDetails, t,
}: Pick<ToolTreeProps, 'renderSlot' | 'selectedCallId' | 'cwd' | 'openFile' | 'inspectCall' | 'openDetails' | 't'> & {
  block: ToolCallBlock
  home?: string | undefined
}) {
  return (
