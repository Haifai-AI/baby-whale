...
class RecordingFileSystem extends FileSystem {
  ...
  override async writeBytes(_target: FsTarget, bytes: Uint8Array, _expected?: FsWriteIntent): Promise<FsBinaryWriteOutcome> {
    return { operation: 'update', version: FsVersion('unused'), size: bytes.byteLength }
  }
