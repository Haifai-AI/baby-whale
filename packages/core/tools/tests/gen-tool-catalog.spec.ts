...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'cordis_undefine', 'create_goal', 'csv_read', 'deliver', 'docx_text', 'edit', 'exit_plan_mode', 'followup_task', 'get_goal', 'glob', 'grep',
      ...
      'update_goal', 'wait_agent', 'web_fetch', 'web_search', 'workflow', 'write', 'xlsx_read',
    ])
