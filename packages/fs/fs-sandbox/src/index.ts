...
import type { FsEditOutcome, FsEditRequest, FsBinaryWriteOutcome, FsTarget, FsVersion, FsWriteIntent, FsWriteOutcome } from '@deepseek-ai/dsh-fs'
...
export class SandboxedFileSystem extends LocalFileSystem {
  ...
  override async writeBytes(
    ...
    return super.writeBytes(await this.checkedTarget(target, sandboxPolicy), bytes, expected, signal)
  }
