...
describe('skills domain schemas', () => {
  it('validates the list request/value pair', () => {
    ...
    const value = skillListValueSchema.parse({ skills: [
      { name: 'commit-helper', description: 'Git commits', whenToUse: 'when committing', modelInvocable: true, userDisabled: false },
      { name: 'bare', description: 'No guidance', modelInvocable: false, userDisabled: false },
    ] })
